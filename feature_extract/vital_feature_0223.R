...
vital_volatile_total = readRDS('preprocessing\\Total_vital_record_NACOL_0223.rds')
...
saveRDS(volatile_summary,"preprocessing/volatile_summary_0223.rds")
...
names(volatile_cpt)[1:length(volatile_cpt)-1] = paste0("cpt_",names(volatile_cpt)[1:length(volatile_cpt)-1])
names(volatile_cpt)
saveRDS(volatile_cpt, "preprocessing/volatile_cpt_0223.rds")
...
saveRDS(volatile_peak, "volatile_peak_mpd10_0223.rds")
...
names(volatile_cre)
saveRDS(volatile_cre, "preprocessing/volatile_cre_0223.rds")
...
saveRDS(volatile_freq, "volatile_freq_0223.rds")
