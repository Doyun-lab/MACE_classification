...
vital_TIVA_total = readRDS('preprocessing\\vital_TIVA_NA_end_ext.rds')
...
unique(emr_vital_tiva[emr_vital_tiva$OP.Time ==0,]$Case_ID)  # VR과 겹치는 case = 1

# 수술시간이 0인 부분 vr의 time변수를 통해 전처리 -> 없음. 
...
saveRDS(TIVA_summary,"TIVA_summary_ext.rds")
...
names(TIVA_cpt)
saveRDS(TIVA_cpt, "TIVA_cpt_ext.rds")
...
saveRDS(TIVA_peak, "TIVA_peak_mpd10_ext.rds")
...
names(TIVA_cre)
saveRDS(TIVA_cre, "TIVA_cre_ext.rds")
...
saveRDS(TIVA_freq, "TIVA_freq_ext.rds")
