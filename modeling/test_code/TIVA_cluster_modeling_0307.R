...
TIVA_cpt = readRDS('preprocessing/TIVA_cpt_0225.rds')
# ----------------------------------------------------------------------------------------------------------------------------------------------
...
total_data3 <- rbind(total_data3, total_data3_abn, total_data3_abn, total_data3_abn, total_data3_abn, total_data3_abn, total_data3_abn, total_data3_abn)
...
set.seed(1234)
TIVA.kmeans <- kmeans(cluster_train, centers = 3, iter.max = 1000)
TIVA.kmeans$centers

total_data3$cluster <- as.factor(TIVA.kmeans$cluster)
qplot(Crystal, Colloid, colour = cluster, data = total_data3)

total_data3$cluster <- as.numeric(total_data3$cluster)

saveRDS(total_data3, "preprocessing/TIVA_emr_rBP_rMedi_rVital_VR")
# ----------------------------------------------------------------------------------------------------------------------------------------------
