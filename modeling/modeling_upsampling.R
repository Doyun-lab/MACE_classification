...
xgb_fit_up = function(input_data){
...
dnn_fit_up = function(input_data){
  ...
  for (i in 1:length(cv_list)){
    ...
    model %>% 
      layer_dense(units = 512, activation = 'relu', input_shape = ncol(up)-1) %>% 
...
# RF 결과 확인
tiva_emr_rf <- rf_fit_up(tiva_emr)
tiva_bp_rf <- rf_fit_up(tiva_bp)
tiva_record_rf <- rf_fit_up(tiva_record)
tiva_red_rf <- rf_fit_up(tiva_red)
tiva_new_rf <- rf_fit_up(tiva_new)

vol_emr_rf <- rf_fit_up(vol_emr)
vol_bp_rf <- rf_fit_up(vol_bp)
vol_record_rf <- rf_fit_up(vol_record)
vol_red_rf <- rf_fit_up(vol_red)
vol_new_rf <- rf_fit_up(vol_new)
...
# XGBoost 결과 확인
tiva_emr_xgb <- xgb_fit_up(tiva_emr)
tiva_bp_xgb <- xgb_fit_up(tiva_bp)
tiva_record_xgb <- xgb_fit_up(tiva_record)
tiva_red_xgb <- xgb_fit_up(tiva_red)
tiva_new_xgb <- xgb_fit_up(tiva_new)

vol_emr_xgb <- xgb_fit_up(vol_emr)
vol_bp_xgb <- xgb_fit_up(vol_bp)
vol_record_xgb <- xgb_fit_up(vol_record)
vol_red_xgb <- xgb_fit_up(vol_red)
vol_new_xgb <- xgb_fit_up(vol_new)
...
# dnn 결과 확인
tiva_emr_dnn <- dnn_fit_up(tiva_emr)
tiva_bp_dnn <- dnn_fit_up(tiva_bp)
tiva_record_dnn <- dnn_fit_up(tiva_record)
tiva_red_dnn <- dnn_fit_up(tiva_red)
tiva_new_dnn <- dnn_fit_up(tiva_new)

vol_emr_dnn <- dnn_fit_up(vol_emr)
vol_bp_dnn <- dnn_fit_up(vol_bp)
vol_record_dnn <- dnn_fit_up(vol_record)
vol_red_dnn <- dnn_fit_up(vol_red)
vol_new_dnn <- dnn_fit_up(vol_new)
